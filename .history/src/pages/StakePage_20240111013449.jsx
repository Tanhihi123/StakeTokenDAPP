...
const StakePage = () => {
  ...
  const { state, handleWallet } = useContext(Web3Context);
  ...
  const provider = new ethers.JsonRpcProvider(
    `https://sepolia.infura.io/v3/${myKeyINFURA}`
  );
  useEffect(() => {
    async function getBalance() {
      ...
      console.log("Balance ETH", showBalance);
    }
    getBalance()
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedAccount]);
              ...
              <div className="flex flex-col items-center mt-8 w-full">
                <div className="flex justify-between mb-[2px] w-full">
                  ...
                  <div className="flex items-baseline justify-center gap-x-3">
                    ...
                    <p className="text-gray-400 text-[15px]">{ balance } $STK</p>
                  </div>
                </div>
